 ...
 *
 * */
$navbar_button_url = !empty(cs_get_option('header_three_navbar_btn_url')) ? cs_get_option('header_three_navbar_btn_url') : esc_url('#');
$navbar_button_text = !empty(cs_get_option('header_three_navbar_btn_text')) ? cs_get_option('header_three_navbar_btn_text') : esc_html__('Download','aapside');
?>
<div class="header-style-02">
	<nav class="navbar navbar-area navbar-expand-lg navbar-style-transparent">
		<div class="container nav-container">
			...
			?>
			<?php
			if(!empty(cs_get_option('header_three_navbar_btn')) || !empty(cs_get_option('header_three_navbar_btn_two'))):
				?>
				<div class="nav-right-content">
					<ul>
						<li class="button-wrapper">
							<?php if (!empty(cs_get_option('header_three_navbar_btn'))):?>
							<a href="<?php echo esc_url($navbar_button_url)?>" class="boxed-btn btn-rounded"><?php echo esc_html($navbar_button_text);?></a>
							<?php endif;?>
							<?php if (!empty(cs_get_option('header_three_navbar_btn_two'))):?>
							<a href="<?php echo esc_url(cs_get_option('header_three_navbar_btn_two_url'))?>" class="boxed-btn btn-rounded"><?php echo esc_html(cs_get_option('header_three_navbar_btn_two_text'));?></a>
							<?php endif;?>
						</li>
					</ul>
				</div>
