 ...
 *
 * */
$navbar_button_url = !empty(cs_get_option('header_four_navbar_btn_url')) ? cs_get_option('header_four_navbar_btn_url') : esc_url('#');
$navbar_button_text = !empty(cs_get_option('header_four_navbar_btn_text')) ? cs_get_option('header_four_navbar_btn_text') : esc_html__('Download','aapside');
?>
<div class="header-style-03">
	<nav class="navbar navbar-area navbar-expand-lg navbar-default">
		<div class="container nav-container">
			...
			?>
			<?php
			if(!empty(cs_get_option('header_four_navbar_btn'))):
				?>
