...
namespace Elementor;
class Appside_Icon_Box_Four_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-icon-box-four-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Icon Box: 04', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(Group_Control_Background::get_type(),[
			'name' => 'featured_icon_background',
			'selector' => "{{WRAPPER}} .single-feature-item-02 .icon:after",
        ...
        $this->add_control('icon_color',[
           'label' => esc_html__('Icon Color','aapside-master'),
	        ...
	        'selectors' => [
	        	"{{WRAPPER}} .single-feature-item-02 .icon" => "color:{{VALUE}}"
	        ]
        ]);
        $this->add_control('title_color',[
           'label' => esc_html__('Title Color','aapside-master'),
	        'type' => Controls_Manager::COLOR,
	        'selectors' => [
	        	"{{WRAPPER}} .single-feature-item-02 .content .title" => "color:{{VALUE}}"
	        ]
        ]);
        $this->add_control('description_color',[
           'label' => esc_html__('Description Color','aapside-master'),
	        'type' => Controls_Manager::COLOR,
	        'selectors' => [
	        	"{{WRAPPER}} .single-feature-item-02 .content p" => "color:{{VALUE}}"
	        ]
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(),[
	        ...
	        'selector' => "{{WRAPPER}} .single-feature-item-02 .content .title"
        ]);
        $this->add_group_control(Group_Control_Typography::get_type(),[
        	'name' => 'description_typography',
	        'label' => esc_html__('Description Typography','aapside-master'),
	        'selector' => "{{WRAPPER}} .single-feature-item-02 .content p"
        ]);
		$this->end_controls_section();
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Icon_Box_Four_Widget() );