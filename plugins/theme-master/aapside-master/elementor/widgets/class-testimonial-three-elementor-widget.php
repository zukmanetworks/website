...
namespace Elementor;
class Appside_Testimonial_Three_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-testimonial-three-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial: 03', 'aapside-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			...
			'selector' => "{{WRAPPER}} .single-testimonial-item-03 .content-area"
		] );
		$this->add_control( 'description_color', [
			'type'      => Controls_Manager::COLOR,
			'label'     => esc_html__( 'Description Color', 'aapside-master' ),
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-03 .content-area p" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'name_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-03 .content-area .author-meta .title" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'designation_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-03 .content-area .author-meta .designation" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'icon_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-03 .content-area:after" => "color: {{VALUE}}"
			]
		] );
		$this->add_control( 'rating_color', [
			...
			'selectors' => [
				"{{WRAPPER}} .single-testimonial-item-03 .content-area .ratings" => "color: {{VALUE}}"
			]
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .single-testimonial-item-03 .content-area p"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'  => 'name_typography',
			'label' => esc_html__( 'Name Typography', 'aapside-master' ),
            'selector' => "{{WRAPPER}} .single-testimonial-item-03 .content-area .author-meta .title"
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'  => 'designation_typography',
			'label' => esc_html__( 'Designation Typography', 'aapside-master' ),
            'selector' => "{{WRAPPER}} .single-testimonial-item-03 .content-area .author-meta .designation"
		] );
	...
	protected function render() {
        ...
        <div class="testimonial-carousel-wrapper appside-rtl-slider">
            <div class="appside-testimonial-carousel-03 owl-carousel"
                 id="testimonial-one-carousel-03-<?php echo esc_attr( $rand_numb ); ?>"
                    ...
                    <div class="single-testimonial-item-03">
                        <div class="content-area">
                            ...
                            <div class="author-meta">
	                            ...
	                            <?php endif; ?>
                                <h4 class="title"><?php echo esc_html( $item['name'] ); ?> <span
                                            class="designation">/ <?php echo esc_html( $item['designation'] ); ?></span>
                                </h4>
                            </div>
                        </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Testimonial_Three_Widget() );