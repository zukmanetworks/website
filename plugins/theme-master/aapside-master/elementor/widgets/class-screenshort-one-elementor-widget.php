...
namespace Elementor;
class Appside_Screenshort_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-screenshort-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Screenshort One', 'aapside-master' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Screenshort_One_Widget() );