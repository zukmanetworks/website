...
namespace Elementor;
class Appside_Icon_Box_Sixteen_Widget extends Widget_Base {
    ...
    public function get_name() {
        return 'appside-icon-box-sixteen-widget';
    }
    ...
    public function get_title() {
        return esc_html__( 'Icon Box: 16', 'aapside-master' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(Group_Control_Background::get_type(),[
            ...
            'selector' => "{{WRAPPER}} .single-icon-box-16 .icon"
        ]);
        $this->add_control(
            'icon_border_radius',
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .single-icon-box-16 .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .single-icon-box-16 .img-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .single-icon-box-16 .icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control( 'icon_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-icon-box-16 .icon"          => "color: {{VALUE}}",
                "{{WRAPPER}} .single-icon-box-16 .icon svg path" => "fill: {{VALUE}}",
            ]
        ] );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single-icon-box-16',
            ]
        );
        ...
        $this->add_control( 'background-color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-icon-box-16" => "background-color: {{VALUE}}"
            ]
        ] );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single-icon-box-16:hover',
            ]
        );
        $this->add_control( 'background-hover-color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-icon-box-16:hover" => "background-color: {{VALUE}}"
            ]
        ] );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .single-icon-box-16 .content .title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control( 'title_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-icon-box-16 .content .title" => "color: {{VALUE}}"
            ]
        ] );
        $this->add_control( 'description_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-icon-box-16 .content p" => "color: {{VALUE}}"
            ]
        ] );
        $this->end_controls_section();
        $this->start_controls_section(
        ...
        $this->add_group_control( Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .single-icon-box-16 .content .title"
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'description_typography',
            'label'    => esc_html__( 'Description Typography', 'aapside-master' ),
            'selector' => "{{WRAPPER}} .single-icon-box-16 .content p"
        ] );
        $this->end_controls_section();
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'icon_box_wrapper', 'class', 'single-icon-box-16' );
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Icon_Box_Sixteen_Widget() );