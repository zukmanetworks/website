...
namespace Elementor;
class Appside_Portfolio_Grid_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'appside-portfolio-grid-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio Grid: 01', 'aapside-master' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Appside_Portfolio_Grid_One_Widget() );